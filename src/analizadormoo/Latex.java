...
public class Latex {
 ...
 public static void Termina_latex_OS() throws FileNotFoundException, IOException
 {
    FileOutputStream fos = new FileOutputStream("OS.tex", true);
  ...
  public static void Inicializa_latex_OS() throws FileNotFoundException, IOException
  {
    //PROMEDIO
    FileOutputStream fos = new FileOutputStream("OS.tex", false);
    PrintStream os=new PrintStream(fos);
    os.print("\\documentclass{article}" + "\n");
    os.print("\\title{Overall Spread}" + "\n");
    ...
    for(int x=0;x<AnalizadorMO.algoritmos;x++)
    {
        ...
        os.print(AnalizadorMO.nombres_algoritmos.get(x)+" &");
        else
        os.print(AnalizadorMO.nombres_algoritmos.get(x)+"");
    }
    os.print("\\\\");
   ...
   public static void printQualityIndicator_OS(ArrayList <Double> Indicator_mean,ArrayList <Double> Indicator_desvest) throws IOException {
    FileOutputStream fos = new FileOutputStream("OS.tex", true);
    PrintStream os=new PrintStream(fos);
    os.print(AnalizadorMO.problema+" &");
    double mayor=0;
    double menor_desv=Double.MAX_VALUE;
    int pos=0;
    int pos2=0;
    for(int x=0;x<AnalizadorMO.algoritmos;x++)
    {
        ...
        {
            if(Indicator_desvest.get(x)<menor_desv)
            {
                pos=x;
                menor_desv=Indicator_desvest.get(x);
            }
        }
        if(Indicator_mean.get(x)>mayor)
        {
    ...
    {
    if(x==pos2)
        os.print("\\cellcolor{gray25}$"+new DecimalFormat("0.00E00").format(Indicator_mean.get(x)) +"_{"+ new DecimalFormat("0.0E00").format(Indicator_desvest.get(x)) +"}$ &");   
    else if(x==pos)
        os.print("\\cellcolor{gray95}$"+new DecimalFormat("0.00E00").format(Indicator_mean.get(x)) +"_{"+ new DecimalFormat("0.0E00").format(Indicator_desvest.get(x)) +"}$ &");   
    else
     os.print("$"+new DecimalFormat("0.00E00").format(Indicator_mean.get(x)) +"_{"+ new DecimalFormat("0.0E00").format(Indicator_desvest.get(x)) +"}$ &");   
   
   
    }
    if(pos==AnalizadorMO.algoritmos-1)
    os.print("\\cellcolor{gray95}$"+new DecimalFormat("0.00E00").format(Indicator_mean.get(AnalizadorMO.algoritmos-1))+"_{"+new DecimalFormat("0.0E00").format(Indicator_desvest.get(AnalizadorMO.algoritmos-1))+"}$");
    else if(pos2==AnalizadorMO.algoritmos-1)
    os.print("\\cellcolor{gray25}$"+new DecimalFormat("0.00E00").format(Indicator_mean.get(AnalizadorMO.algoritmos-1))+"_{"+new DecimalFormat("0.0E00").format(Indicator_desvest.get(AnalizadorMO.algoritmos-1))+"}$");
    else
    os.print("$"+new DecimalFormat("0.00E00").format(Indicator_mean.get(AnalizadorMO.algoritmos-1))+"_{"+new DecimalFormat("0.0E00").format(Indicator_desvest.get(AnalizadorMO.algoritmos-1))+"}$");
